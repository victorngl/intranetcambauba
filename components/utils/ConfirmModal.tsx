...
export default function ConfirmModal({ open, setOpen, children, performerDelete, idToDelete }) {
                    ...
                    <div className="relative w-full max-w-md max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-6 text-center">
                                ...
                                <button onClick={(e) => { performerDelete(idToDelete); setOpen(false) }} type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    Sim
                                </button>
